...
Today Current Date and Time:\n ${date} at ${time} local time in the ${timezone} timezone. Use this information to ensure all time-related responses are accurate and contextually relevant based on the user's location.
...
export const SUMMARY_JSON_STRUCTURE = {
    summary: "Summary of the conversation goes here",
};
...
export const CHECK_FOR_COMPLETION_PROMPT = `
...
export const VOICEMAIL_DETECTION_PROMPT = `
...
export const LANGUAGE_DETECTION_PROMPT = (transcripts: string) => `
...
export const EXTRACTION_PROMPT_GENERATION_PROMPT = `
...
export const FILLER_PROMPT =
    "Please, do not start your response with fillers like Got it, Noted.\nAbstain from using any greetings like hey, hello at the start of your conversation";

export const DATE_PROMPT = (date: string, time: string, timezone: string) =>
    `### Today Current Date and Time:\n ${date} at ${time} local time in the ${timezone} timezone. Use this information to ensure all time-related responses are accurate and contextually relevant based on the user's location.`;
